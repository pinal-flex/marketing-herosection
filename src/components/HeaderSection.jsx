    ...
    <div className="relative py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <div className="flex flex-wrap mt-16 sm:mt-20 gap-8 sm:gap-4 sm:flex-row justify-between whitespace-nowrap">
            {stats.map((state) => (
              <div key={state.name} className="flex flex-col gap-1 text-left flex-1">
